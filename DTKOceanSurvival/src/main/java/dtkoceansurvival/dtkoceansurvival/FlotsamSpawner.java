...
class FlotsamSpawner implements Listener {
    ...
    FlotsamSpawner(JavaPlugin owner, World world, Random new_random) {
        random = new_random;
    ...
    void updateSpawner(LootTable new_lootTable, Boat.Type new_type){
    ...
    void findValidLocation(Vector direction, int range){
        maxRange = range;
